...
In this study, we investigated whether neural network pointing models can replace traditional analytical linear regression models in radio/(sub)-mm telescopes.
...
% Interestingly, the architectures incorporating distinct layers for the terms employed in the analytical pointing models used fewer neurons in their nonlinear layers.
