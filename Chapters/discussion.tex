...
The results from this case, presented in Table \ref{tab:results_minval_val_test_days_04_n230}, demonstrated that the model's performance on the validation set is promising,
